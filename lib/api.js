...
var Api = function(config) {
    ...
    config = this.config = _.extend({}, this.config, config);
    ...
    _.extend(this.requestOptions, {
        ...
        mimetypes: {
            json: ["application/json", "application/json; charset=utf-8", "application/json; charset=utf-8; x-api-version=2.1"]
        }
    ...
    this.client.parsers.add({
        ...
        "parse": function (byteBuffer, nrcEventEmitter, parsedCallback) {
            ...
            try {
                ...
                var bodyResponse = byteBuffer.toString();
